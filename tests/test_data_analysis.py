import pandas as pd
import numpy as np
from nuanic_ring.data_analysis import fit_mm_equation_from_export, analyze_stress, detect_peaks, calculate_correlation
...
def test_fit_mm_equation_2f():
    ...
    df = pd.DataFrame({
        ...
        "srl": [100000.0, 100001.0, 100000.0, 100002.0, 100000.0, 100001.0, 100000.0, 100002.0, 100000.0],
